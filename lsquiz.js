...
const questions = [
  ...
  },
  {
    ...
    options: [
      { text: "짐 싸, 지금 당장! 카메라 하나 들고 발견 장소로 즉시 출발한다.", style: "A" },
      { text: "발견자에게 바로 컨택한다. 언제, 어디서, 어떤 상태로 발견됐는지 팩트 체크부터 해야 한다.", style: "T" },
      { text: "합성이 아니라고? 보도의 진위 여부를 살피고, 만약 진짜라면 역사 속 유니콘 묘사들과의 공통점을 분석한다.", style: "R" },
      { text: "이걸로 논문 쓰면 대박인데. 이 발견이 내 커리어와 학계에 미칠 영향력과 활용 방안을 머릿속으로 계산한다.", style: "P" },
    ],
  },
  {
    id: 18,
    ...
    options: [
      { text: "금발 ✅ 푸른 눈 ✅ 귀족 ❌. 지금까지 만난 적 없는 외모의 여성을 추려 수소문하는 논리적 제거법을 추천한다.", style: "T" },
      { text: "애초에 잡았어야지! 집 주소라도 따 놓거나 전담 마크를 붙였어야 한다고 팩폭한다.", style: "A" },
      { text: "발 사이즈 데이터부터 모으시죠. 특정 연령대 여성의 발 사이즈를 전수조사해 동선을 최소화하는 효율적 수색을 제안한다.", style: "P" },
      { text: "그녀의 손을 기억해 보세요. 화려한 겉모습과 달리 손에 굳은살이 있었다면, 몰락한 귀족 가문을 찾는 게 빠를 거라고 분석한다.", style: "R" },
    ],
  },
  {
    id: 19,
    ...
    options: [
      { text: "오히려 좋아, 칼퇴 각. 주어진 서류 업무를 가장 빠르고 효율적으로 처리해 실력을 인정받는다.", style: "P" },
      { text: "나랑 비슷한 능력을 가진 선배들은 어땠지? 과거 사례를 찾아보며 내 능력이 나중에 어떤 의미를 가질지 고찰한다.", style: "R" },
      { text: "회사의 데이터베이스를 털어(?)본다. 히어로 체계와 빌런의 패턴을 이론적으로 완벽히 학습하며 때를 기다린다.", style: "T" },
      { text: "현장이 답이다. 몰래 현장 팀원들이랑 친해져서 번개로 출동 나갈 기회를 호시탐탐 노린다.", style: "A" },
    ],
  },
  {
    id: 20,
    ...
    options: [
      { text: "설정값 분석 시작. 마법 체계, 정치 구조 등 이 세계의 작동 원리를 파악해 생존 로직을 설계한다.", style: "T" },
      { text: "일단 관망한다. 주변 인물들의 관계도를 살피며 섣불리 움직이지 않고 최적의 타이밍을 기다린다.", style: "R" },
      { text: "생존 루트 최단거리 검색. 감정 낭비 빼고, 지금 당장 내가 가진 자금과 인맥으로 살길부터 빠르게 계산한다.", style: "P" },
      { text: "일단 즐겨! 3년이나 남았는데 뭘 벌써 걱정해? 이 세계의 모든 걸 경험하며 살다 보면 길이 열릴 거라 믿는다.", style: "A" },
    ],
  },
];
