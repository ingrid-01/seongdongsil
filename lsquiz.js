...
const questions = [
  ...
  },
  {
    ...
    options: [
      {
        text: "새로 생긴 곳 가보자고 한다. 실패해도 재밌으면 됨.",
        style: "A",
      },
      {
  ...
  },
  {
    ...
    options: [
      {
        text: "평점과 반응 좋은 흥행작을 고른다. 실패 없이 재밌게 보는 게 중요하다.",
        style: "P",
      },
      {
        text: "화려하진 않아도 감정선이 깊은 영화를 선호한다. 오래 여운이 남는 작품이 좋다.",
        style: "R",
      },
      {
  ...
  },
  {
    ...
    options: [
      ...
      {
        text: "돈도 절약하고 접근성이 좋은 회사 헬스장을 이용한다.",
        style: "P",
      },
      {
  ...
  },
  {
    ...
    options: [
      ...
      {
        text: "이 일의 핵심 메커니즘이 뭐지? 업무의 전체적인 구조와 원리를 먼저 공부한다.",
        style: "T",
      },
    ],
  },
  {
    ...
    options: [
      {
        text: "플랜 B 가동. 웨이팅이나 동선 낭비를 최소화할 수 있는 가장 효율적인 대안을 빠르게 찾아낸다.",
        style: "P",
      },
      {
  ...
  },
  {
    ...
    options: [
      ...
      {
        text: "과학적인 근거가 없군. 헛소리라 치부하고 그냥 물이나 많이 마셔야겠다고 생각한다.",
        style: "T",
      },
    ],
  },
  {
    ...
    options: [
      ...
      {
        text: "최초 발견자에게 바로 연락한다. 언제, 어디서, 어떤 상태로 발견됐는지 팩트 체크부터 해야 한다.",
        style: "T",
      },
      {
  ...
  },
  {
    ...
    options: [
      {
        text: "이 세계는 왜 이렇게 돌아가지? 마법 체계, 정치 구조, 사건 흐름 등 죽음의 경우의 수를 분석해본다.",
        style: "T",
      },
      {
