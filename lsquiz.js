...
const questions = [
  ...
  },
  {
    ...
    options: [
      ...
      {
        text: "목표를 정하고 그에 맞는 기능부터 배운다. 굳이 사용 안 하는 기능까지 알 필욘 없지.",
        style: "P",
      },
      {
  ...
  {
    id: 6,
    text: "이틀 뒤, 시험을 치뤄야 해야한다. 나는:",
    options: [
      {
        text: "이틀밖에 남지 않아서 조금 불안하다. 시간이 조금만 더 있었다면 좋았을 텐데... 기출문제 풀어보고 오답노트 정리하고 강의 1.75배로 한 번씩 더 보고 싶은데 시간이 타이트하다.",
        style: "R",
      },
      {
        text: "이틀 남았으면 충분하지! 족보 한 번 쭉 훑어보고 친구한테 전화해서 서로 문제 내주는 식으로 공부하면 재밌겠다. 어차피 시험장 가면 다 생각나겠지.",
        style: "A",
      },
      {
        text: "이 시점에서 새로운 내용을 공부해봤자 장기기억으로 남지 않는다. 그냥 반복 복습하면서 최대한 효율적으로 단기기억력을 끌어올려본다.",
        style: "P",
      },
      {
        text: "지금까지 공부한 걸 빈 종이에 수형도(트리 다이어그램)로 적어본다. 미흡한 부분이 있다면 복습하고, 기억하고 있는 부분은 과감히 건너뛴다.",
        style: "T",
      },
    ],
  },
  {
    id: 7,
    text: "스터디 모임에서 의견 충돌이 생겼다. 내가 운영진이라면 어떻게 행동할까?",
    options: [
      {
        text: "일을 최대한 키우지 않고 가장 현실적인 해결책을 제안한다.",
        style: "P",
      },
      {
        text: "최대한 많은 데이터를 모아본다. 여러 의견을 들어보고 상황을 파악해본다.",
        style: "R",
      },
      { text: "바로 내 생각을 공유하고 멤버들과의 토론을 이끈다.", style: "A" },
      {
        text: "감정을 배제하고 이성적으로 접근하여 문제의  근본적인 원인을 찾아 분석한다.",
        style: "T",
      },
    ],
  },
  {
    id: 8,
    text: "점메추! 오늘 모임 멤버들이랑 점심을 같이 먹기로 했다. 나는:",
    options: [
      {
        text: "돈까스가 먹고 싶다. 멤버들한테 돈까스가 얼마나 맛있는지 예찬론을 펼치기 시작한다.",
        style: "A",
      },
      {
        text: "모인 장소 근처 맛집들을 검색해 각 식당의 리뷰를 꼼꼼히 읽어보고, 메뉴 구성과 가격대를 비교해 가장 합리적인 선택지를 도출해낸다.",
        style: "T",
      },
      {
        text: "밥 먹고 또 공부를 해야하니까 너무 무겁지 않게 간단한 김밥이나 햄버거 정도를 추천한다.",
        style: "P",
      },
      {
        text: "다른 사람들의 의견을 다 들어보고 거의 마지막에 내 의견을 공유한다.",
        style: "R",
      },
    ],
  },
  {
    id: 9,
    text: "친구 생일 선물을 사러 나왔다. 나는:",
    options: [
      {
        text: "그 친구의 취향, 요즘 관심사, 이미 갖고 있는 것들을 머릿속으로 정리해본다. 몇 가지 후보를 비교해보고 가장 의미 있을 것 같은 선물을 고른다.",
        style: "T",
      },
      {
        text: "저번에 그 친구가 필요로 했던 물건을 사준다. 역시 선물은 효율성 있는 게 짱이다.",
        style: "P",
      },
      {
        text: "다른 친구들이 뭘 사는지 물어보고 겹치지 않게 제일 마지막에 선물을 고른다.",
        style: "R",
      },
      { text: "요즘 유행하는 디저트를 산다! 아직 못 먹어봤겠지?", style: "A" },
    ],
  },
  {
    id: 10,
    ...
    options: [
      {
        text: "요즘 흥행하는 영화를 본다. 친구들 사이에서도 회사에서도 다 이 영화 얘기뿐이니 나도 봐야지 스몰토크가 가능해진다. (P)",
        style: "P",
      },
      {
        text: "내가 보고 싶던거랑 연인이 보고 싶던 것 중 하나를 본다. 사실 어떤 영화를 보는게 중요한 게 아니라 같이 본 사람과 충분히 얘기를 나눌 수 있는게 더 가치 있다고 생각한다.",
        style: "R",
      },
      { text: "아묻따 마블 신작 ㄱㄱ", style: "A" },
      {
        text: "올해 황금종려상을 받은 가족의 관계성을 그린 외국 영화를 본다. 보고 나서 왓챠후기도 남겨야지.",
        style: "T",
      },
    ],
  },
  ...
  },
  {
    ...
    options: [
      { text: "패닉한다. 모르는 걸 어떻게 하라는거지? 일단 일은 해야 하니까 최대한 많은 데이터를 모아본다.", style: "R" },
      { text: "내가 이 업무를 실행하기 어려울 것이라 상사에게 먼저 얘기해본다. 그래서 내가 할 수 있는 현실적인 타협점을 찾아본다.", style: "P" },
      { text: "일단 해본다. 잘 모르겠지만 그래도 상사가 날 그만큼 신뢰한다는 거겠지? 긍정적으로 생각해본다.", style: "A" },
      { text: "이 업무가 정확히 무엇인지부터 파악한다. 어떤 개념과 원리가 필요한지, 어디서부터 시작해야 하는지 구조를 먼저 그려본다. 공부가 필요하다면 기꺼이 한다.", style: "T" },
    ],
  },
    {
    id: 13,
    ...
    options: [
      { text: "최대한 효율적으로 동선을 다시 짜본다. 웨이팅 긴 맛집이나 시간을 빠듯하게 맞춰야 하는 영화보단 연인과 함께 편안한 시간을 보내는게 더 우선순위다.", style: "P" },
      { text: "일단 뭐가 왜 틀어진 건지부터 파악한다. 예약을 안 한 건지, 시간 계산을 잘못한 건지. 이유를 알아야 다음 선택을 할 수 있다. 남은 일정과 이동 시간을 머릿속으로 정리해보고, 지금 상황에서 가장 논리적인 선택지를 연인에게 설명하며 제안한다.", style: "T" },
      { text: "발 닿는데로 간다. 계획이 조금 틀어진다고 즐거운 데이트를 못 할 이유는 없다!", style: "A" },
      { text: "계획대로 하지 못해서 조금 서운하다. 하지만 새로 계획을 세우기엔 힘들 것 같고, 연인과 여러 대화를 나눠보면서 할 수 있는 대안을 찾아본다.", style: "R" },
    ],
  },
  /*  
  {
